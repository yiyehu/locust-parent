...
public class Constants {
    ...
    public static final String LOCUST_PROPERTIES_KEY = "locust.properties.file";

    public static final String DEFAULT_LOCUST_PROPERTIES = "locust.properties";
    ...
    public static final String DEFAULT_DIRECTORY = "locust";
    ...
    public static final String DEFAULT_REMOTING_CODEC = "locust";
...
//    public static final int DEFAULT_REGISTRY_CONNECT_TIMEOUT = 5000;
    ...
    public static final String DEFAULT_REGISTRY = "locust";
    ...
    public static final String DEFAULT_PROMPT = "locust>";
    ...
    public static final String LOCUST_VERSION_KEY = "locust";
    ...
    @Deprecated
    public static final String SHUTDOWN_WAIT_SECONDS_KEY = "locust.service.shutdown.wait.seconds";

    public static final String SHUTDOWN_WAIT_KEY = "locust.service.shutdown.wait";
    ...
    public static final String STUB_EVENT_KEY = "locust.stub.event";

    public static final boolean DEFAULT_STUB_EVENT = false;

    public static final String STUB_EVENT_METHODS_KEY = "locust.stub.event.methods";
    ...
    public static final String LOCUST_IP_TO_REGISTRY = "LOCUST_IP_TO_REGISTRY";

    public static final String LOCUST_PORT_TO_REGISTRY = "LOCUST_PORT_TO_REGISTRY";

    public static final String LOCUST_IP_TO_BIND = "LOCUST_IP_TO_BIND";

    public static final String LOCUST_PORT_TO_BIND = "LOCUST_PORT_TO_BIND";
    ...
    public static final String TAG_KEY = "locust.tag";

    public static final String FORCE_USE_TAG = "locust.force.tag";
